...
- **Last updated:** 2026-03-20 15:18:57 UTC
- **Nextflow version:** 26.03.0-edge

## Pipelines

- **Strict syntax:** 0 parse errors, 6 errors, 119 warnings across 19 pipelines
- **Zero issues:** 10 pipelines (52.6%)
...
| :x: [curationpretext](https://github.com/sanger-tol/curationpretext)                            |     No      |      0 |        2 |     No      |    [View](lint_results/pipeline-results/curationpretext_lint.md)    |    [View](lint_results/prints-help-results/curationpretext_help.txt)    |
...
- **Topic + Version:** 25/25 (100.0%) modules have `topics:` and `versions:` in meta.yml
- **Zero errors:** 25 modules (78.1%)
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------: | -----: | -------: | :----------------: | :----------------: | :----------------------------------------------------------------------------: |
| :x: [asmstats](https://github.com/sanger-tol/nf-core-modules/tree/main/modules/sanger-tol/asmstats)                                                                    |     No      |      0 |        0 |        :x:         |        :x:         |              [View](lint_results/module-results/asmstats_lint.md)              |
| :x: [bgziptabix](https://github.com/sanger-tol/nf-core-modules/tree/main/modules/sanger-tol/bgziptabix)                                                                |     No      |      0 |        0 |        :x:         |        :x:         |             [View](lint_results/module-results/bgziptabix_lint.md)             |
| :x: [contactbed](https://github.com/sanger-tol/nf-core-modules/tree/main/modules/sanger-tol/contactbed)                                                                |     No      |      0 |        0 |        :x:         |        :x:         |             [View](lint_results/module-results/contactbed_lint.md)             |
| :x: [generatecontactsindex](https://github.com/sanger-tol/nf-core-modules/tree/main/modules/sanger-tol/generatecontactsindex)                                          |     No      |      0 |        0 |        :x:         |        :x:         |       [View](lint_results/module-results/generatecontactsindex_lint.md)        |
| :x: [hifiasm](https://github.com/sanger-tol/nf-core-modules/tree/main/modules/sanger-tol/hifiasm)                                                                      |     No      |      0 |        0 |        :x:         |        :x:         |              [View](lint_results/module-results/hifiasm_lint.md)               |
| :x: [pretextannotate](https://github.com/sanger-tol/nf-core-modules/tree/main/modules/sanger-tol/pretextannotate)                                                      |     No      |      0 |        0 |        :x:         |        :x:         |          [View](lint_results/module-results/pretextannotate_lint.md)           |
| :x: [restructurebuscodir](https://github.com/sanger-tol/nf-core-modules/tree/main/modules/sanger-tol/restructurebuscodir)                                              |     No      |      0 |        0 |        :x:         |        :x:         |        [View](lint_results/module-results/restructurebuscodir_lint.md)         |
