...
<details>
<summary>Module Results (25 modules)</summary>
...
| :x: [blobtoolkit_generateparamsfile](https://github.com/sanger-tol/nf-core-modules/tree/main/modules/sanger-tol/blobtoolkit/generateparamsfile)         |     No      |      0 |        0 |        :x:         | :white_check_mark: |   [View](lint_results/module-results/blobtoolkit_generateparamsfile_lint.md)   |
| :x: [curationpretext_generateparamsfile](https://github.com/sanger-tol/nf-core-modules/tree/main/modules/sanger-tol/curationpretext/generateparamsfile) |     No      |      0 |        0 |        :x:         | :white_check_mark: | [View](lint_results/module-results/curationpretext_generateparamsfile_lint.md) |
...
- **Versions channel:** 18/20 (90.0%) subworkflows do not emit a `versions` output channel
- **Zero errors:** 18 subworkflows (90.0%)
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------: | -----: | -------: | :----------------: | :---------------------------------------------------------------------------------------: |
| :x: [ancestral_annotation](https://github.com/sanger-tol/nf-core-modules/tree/main/subworkflows/sanger-tol/ancestral_annotation)                                                        |     No      |      0 |        0 |        :x:         |           [View](lint_results/subworkflow-results/ancestral_annotation_lint.md)           |
| :x: [bam2cool](https://github.com/sanger-tol/nf-core-modules/tree/main/subworkflows/sanger-tol/bam2cool)                                                                                |     No      |      0 |        0 |        :x:         |                 [View](lint_results/subworkflow-results/bam2cool_lint.md)                 |
